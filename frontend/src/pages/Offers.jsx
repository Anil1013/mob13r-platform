            ...
            <div style={styles.manageCard}>
              ...
              <div style={styles.workflowGrid}>
                <div style={styles.workflowItem}>
                   ...
                   <input placeholder="AF Prep URL (#HEADERS_B64#)" style={styles.workflowInput} defaultValue={selectedOffer.af_prepare_url} onBlur={e => updateOffer(selectedOffer.id, {af_prepare_url: e.target.value})} />
                </div>
                <div style={styles.workflowItem}>
                   <label style={styles.checkLabel}><input type="checkbox" defaultChecked={selectedOffer.has_status_check} onChange={e => updateOffer(selectedOffer.id, {has_status_check: e.target.checked})} /> Status Check (Shemaroo)</label>
                   <input placeholder="Status Check URL (#MSISDN#)" style={styles.workflowInput} defaultValue={selectedOffer.check_status_url} onBlur={e => updateOffer(selectedOffer.id, {check_status_url: e.target.value})} />
                </div>
                <div style={styles.workflowItem}>
                   <label style={styles.checkLabel}>Workflow Mode</label>
                   <select style={styles.workflowInput} defaultValue={selectedOffer.af_trigger_point} onChange={e => updateOffer(selectedOffer.id, {af_trigger_point: e.target.value})}>
