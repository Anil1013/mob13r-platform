    ...
    <>
      ...
      <div style={page}>
        <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:32}}>
          <div><h1 style={{fontFamily:"Lora,serif",fontSize:28,fontWeight:700,color:"#1e293b"}}>Advertisers</h1><p style={{color:"#64748b",fontSize:13,marginTop:4}}>{list.length} total</p></div>
        </div>
        <div style={{display:"flex",flexDirection:"column",gap:24}}>
          <div style={{background:"#ffffff",border:"1px solid #e2e8f0",borderRadius:16,padding:24,boxShadow:"0 1px 3px rgba(0,0,0,0.05)"}}>
            <h3 style={{fontFamily:"Lora,serif",fontSize:16,fontWeight:600,color:"#1e293b",marginBottom:20}}>Add Advertiser</h3>
          ...
          <div style={{background:"#ffffff",border:"1px solid #e2e8f0",borderRadius:16,padding:24,boxShadow:"0 1px 3px rgba(0,0,0,0.05)"}}>
            <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:20}}>
              <h3 style={{fontFamily:"Lora,serif",fontSize:16,fontWeight:600,color:"#1e293b"}}>All Advertisers</h3>
