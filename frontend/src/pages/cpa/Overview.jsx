...
const compactSelect = { background: "#fff", border: "1px solid rgba(210,160,180,0.35)", color: "#4a2f3f", padding: "6px 8px", borderRadius: 8, fontSize: 12, cursor: "pointer", fontFamily: "'Lora',sans-serif", minWidth: 0 };
const compactInput = { ...compactSelect, cursor: "text" };
const compactBtn = { background: "linear-gradient(135deg,#e8856a,#d4709a)", color: "#fff", border: "none", padding: "7px 14px", borderRadius: 8, fontSize: 12, fontWeight: 600, cursor: "pointer", fontFamily: "'Lora',sans-serif", whiteSpace: "nowrap" };
const toggleBtn = (active) => ({
  padding: "7px 16px", borderRadius: 8, fontSize: 12, fontWeight: 700, cursor: "pointer", border: "1px solid rgba(210,160,180,0.35)",
  background: active ? "linear-gradient(135deg,#e8856a,#d4709a)" : "#fff", color: active ? "#fff" : "#4a2f3f", fontFamily: "'Lora',sans-serif",
});
