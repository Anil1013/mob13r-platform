      ...
      <div style={S.card}>
        ...
        <form onSubmit={handleLogin} style={{display:"flex",flexDirection:"column",gap:20}}>
          <div style={S.field}>
            ...
            <input type="email" value={email} onChange={e=>setEmail(e.target.value)} required placeholder="admin@mob13r.com" style={S.input}/>
          </div>
          <div style={S.field}>
            <label style={S.label}>Password</label>
            <div style={{position:"relative"}}>
              <input type={show?"text":"password"} value={password} onChange={e=>setPassword(e.target.value)} required placeholder="••••••••" style={S.input}/>
