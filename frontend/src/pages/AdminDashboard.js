...
export default function AdminDashboard() {
  ...
  const AffiliatesSection = () => (
    <div style={styles.section}>
      ...
      <p style={{ color: "#94a3b8" }}>Affiliate management data here.</p>
    </div>
  );
  ...
  const PartnersSection = () => (
    <div style={styles.section}>
      ...
      <p style={{ color: "#94a3b8" }}>Partner management data here.</p>
    </div>
  );
  ...
  const OffersSection = () => (
    <div style={styles.section}>
      ...
      <p style={{ color: "#94a3b8" }}>Offer management data here.</p>
    </div>
  );
