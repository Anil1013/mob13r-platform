  ...
  return (
    <div style={S.page}>
      ...
      <div style={S.header}>
        ...
        <p style={S.sub}>Manage all organizations</p>
      </div>
            ...
            {loading ? (
              ...
              <tr key={org.id}>
                ...
                <td style={S.td}>
                  <input
                    type="number"
                    defaultValue={org.max_publishers}
                ...
                <td style={S.td}>
                  <input
                    type="number"
                    defaultValue={org.monthly_conversions}
                ...
                <td style={S.td}>
                  <button
                    onClick={() => updateOrg(org.id, { status:"active", plan:"pro", max_publishers:999, max_offers:999, monthly_conversions:999999 })}
                    style={S.approveBtn}
                  >
                    ✓ Free Approve
                  </button>
...
const S = {
  ...
  toast:{position:"fixed",top:24,right:24,zIndex:9999,padding:"12px 20px",borderRadius:12,fontSize:13,fontWeight:500},
