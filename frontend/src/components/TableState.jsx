      ...
      <td colSpan={colSpan} style={{ padding: "40px 20px", textAlign: "center", border: "none", background: "#fff" }}>
        {loading ? (
          <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 10 }}>
            ...
            <span style={{ fontSize: 13, color: "#a888b3", fontFamily: "'Lora',sans-serif" }}>{loadingText}</span>
          </div>
        ) : (
          <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 6 }}>
            <span style={{ fontSize: 28, opacity: 0.5 }}>{emptyIcon}</span>
            <span style={{ fontSize: 13, color: "#a888b3", fontFamily: "'Lora',sans-serif" }}>{emptyText}</span>
          </div>
        )}
      </td>
    </tr>
