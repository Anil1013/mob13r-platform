...
export const tabBtn = { padding:"9px 18px", borderRadius:10, border:"1px solid rgba(210,160,180,0.35)", background:"#fff", color:"#9b7faa", fontSize:13, fontWeight:600, cursor:"pointer", fontFamily:font };
...
export const statCard = { background:"#fff", border:"1px solid rgba(210,160,180,0.3)", borderRadius:12, padding:"8px 16px", minWidth:110, boxShadow:"0 2px 8px rgba(210,160,180,0.12)" };
