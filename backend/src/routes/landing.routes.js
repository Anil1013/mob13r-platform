...
router.post("/", async (req, res) => {
  try {
    ...
    /* ================= SAFE FILE HANDLING ================= */
    // ✅ Check for files and prevent 'Unexpected end of form'
    if (req.files && req.files.imageFile) {
      ...
      if (file && file.name) {
        ...
        // ✅ Using Promise-based move to ensure form doesn't end prematurely
    ...
    // ✅ Catch block to prevent 500 status crash
    res.json({
      status: "FAILED",
      error: err.message,
    });
