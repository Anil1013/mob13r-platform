...
advertiserRes=err?.response?.data||{};
}
}
...
const resp=
verifyMethod==="POST"
?await axios.post(verifyUrl,payload,{timeout:AXIOS_TIMEOUT})
:await axios.get(verifyUrl,{params:payload,timeout:AXIOS_TIMEOUT});
